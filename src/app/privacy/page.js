...
export default function PrivacyPolicyPage() {
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-6 py-16 text-[#2D2D32] sm:px-10">
      <article className="prose prose-neutral max-w-none">
        <h1 className="text-4xl font-semibold tracking-tight">Privacy Policy</h1>
        <p className="mt-3 text-sm text-[#6B6B73]">Last updated: September 2026</p>
        ...
        <p className="mt-4 leading-7">
          ...
          us at{" "}
          <a
            className="text-[#FD366E] underline underline-offset-4"
